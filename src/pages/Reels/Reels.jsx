...
const Reels = () => {
  ...
  let [idx4, setIdx4] = useState(null);
  ...
  return (
    <>
      <div className="w-[550px]   overflow-y-auto  overflow-x-hidden grid ">
        {data?.map((elem) => {
          return (
            <div className="w-[90%]      items-center mt-5 ">
              <div>
                ...
                <div className="relative">
                  <div className="absolute bottom-[120px] z-1 left-[440px]">
                    {elem?.postLike ? (
                      <Favorite
                        style={{
                          color: "red",
                    ...
                    <div className=" grid grid-cols-1 items-center">
                      ...
                      />
                      <h1 className="text-white ml-3">{elem.commentCount}</h1>
                    </div>
                  ...
                  <div className="absolute bottom-[80px] p-[10px]  ml-[10px] ">
                    <div className="flex items-center w-[300px]  gap-[20px] ">
                      ...
                      />
                      {users.map((Element) => {
                        if (Element.id == elem.userId) {
                          return (
                            <Link to={`/basic/user/${elem.userId}`}>
