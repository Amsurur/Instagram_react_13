...
const data1=useSelector((state)=>state.todo.data1)
...
<>
    ...
    <div data-aos="fade-right" data-aos-duration="800" className='searchModal  p-[22px] fixed  w-[390px] bg-white ml-[6%] z-99  '>
      <h1 className='text-[24px] mb-[6vh]'>Поисковый запрос</h1>
        <input onChange={(e)=>setSearch(e.target.value) } onInput={(e)=>dispatch(searchData(e.target.value))}  type="text" className='bg-[#f4f3f3] w-[100%] rounded-[7px] text-[14px] outline-none text-black p-[8px] px-[13px] ' placeholder='Поиск...'  />
        <p className="mt-[4vh] border-t-gray-400 border-t-[1px]"></p>

    <div className="  h-[100vh] mt-[4vh] w-[106%]  " >
